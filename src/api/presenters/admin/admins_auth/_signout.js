...
const errCode = 'ERROR_ADMIN_AUTH_SIGNOUT'
...
export default async (data) => {
  ...
  let resultFindAdmin = await servFindOneAdmin(data.email, 'email', ['password', 'tokenResetPassword', 'tokenSignupConfirmation', 'deleted'], false)
  ...
  if (!resultCreatePassword.success || !resultCreatePassword.data) { return (httpMsg.http422('Error to generate admin password.', errCode)) }
